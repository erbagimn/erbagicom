                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        <?php echo e(__('Informasi Komunitas')); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li class="active"><a href="<?php echo e(route('shops.create')); ?>"><?php echo e(__('Buat Komunitas')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <form class="" action="<?php echo e(route('community.add')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php if(!Auth::check()): ?>
                                <div class="form-box bg-white mt-4">
                                    <div class="form-box-title px-3 py-2 bg-red">
                                        <?php echo e(__('Detail Info')); ?> 
                                    </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group--style-1">
                                                        <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('Nama Komunitas')); ?>" name="name">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group--style-1">
                                                        <input type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('Email Komunitas')); ?>" name="email">
                                                        <span class="input-group-addon">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-2">
                                            <label><?php echo e(__('Logo Komunitas')); ?></label>
                                        </div>
                                        <div class="col-md-10">
