                                ...
                                <div class="col-md-6">
                                    <div class="float-md-right">
                                        <ul class="breadcrumb">
                                            ...
                                            <li><a href="<?php echo e(route('community.lists')); ?>"><?php echo e(__('Daftar Sekolah')); ?></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="products-box-bar p-3 bg-white">
                            <div class="container">
                                <div class="row sm-no-gutters gutters-5">
                                    <div class="col">
                                        <div class="bg-white">
                                            <?php $__currentLoopData = $communities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="event-menu">
                                                        <h3 class="event-name">
                                                            <a href="<?php echo e(route('community.visit', $cm->slug)); ?>" ><?php echo e(__($cm->name)); ?></a>
                                                        </h3>
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <!-- Rating stars -->
                                                                <div class="rating mb-1">
                                                                    ...
                                                                    <p>
                                                                        ...
                                                                        <?php if( !is_null($cm->address) ): ?>
                                                                            <strong><i>  
                                                                                <?php echo e($cm->address); ?>  
                                                                             </i></strong>
                                                            ...
                                                            <div class="col-12">
                                                                 <a href="#">
                                                                     <div class="row no-gutters align-items-center">
                                                                        <div>
                                                                                <div class="img">
                                                                                        <img src="<?php echo e(asset($cm->logo)); ?>" class="img-fluid" style="width:200px;">
                                                                                </div>
                                                                        </div>       
                                                                    </div>
                                                                </a>
