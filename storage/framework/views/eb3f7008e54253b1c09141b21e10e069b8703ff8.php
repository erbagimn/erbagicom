                        ...
                        <div class="card">
                            <div class="text-center px-35 pt-5">
                                <h3 class="heading heading-4 strong-500">
                                    <?php echo e(__('Login ke akun anda.')); ?>
                                        ...
                                        <form class="form-default" role="form" action="<?php echo e(route('user.login.submit')); ?>" method="POST">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-right">
                                                    <a href="<?php echo e(route('password.request')); ?>" class="link link-xs link--style-3"><?php echo e(__('Lupa password?')); ?></a>
                                                </div>
                                            </div>
                            ...
                            <div class="text-center px-35 pb-3">
                                <p class="text-md">
                                    <?php echo e(__('Sudah punya Akun ?')); ?> <a href="<?php echo e(route('user.registration')); ?>" class="strong-600"><?php echo e(__('Daftar Sekarang')); ?></a>
                                </p>
                            </div>
                        </div>
                    </div>
