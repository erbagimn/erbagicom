                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                <label class="control-label"><?php echo e(__('Postal code')); ?></label>
                                                <input type="text" class="form-control" placeholder="<?php echo e(__('Postal code')); ?>" name="postal_code" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-feedback">
                                                <label class="control-label"><?php echo e(__('Phone')); ?></label>
                                                <input type="text" class="form-control" placeholder="<?php echo e(__('Phone')); ?>" name="phone" required>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row align-items-center pt-4">
                            ...
                            <div class="col-6 text-right">
                                <button type="button" class="btn btn-styled btn-base-1" onclick="getPaymentInfo()"><?php echo e(__('Continue to Payment')); ?></button>
                            </div>
                        </div>
                    </form>
                </div>
