                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h2 class="heading heading-6 text-capitalize strong-600 mb-0">
                                        <?php echo e(__('Create Proposal Kegiatan')); ?>
                        ...
                        <form class="" action="<?php echo e(route('community_event.submit')); ?>" method="POST" enctype="multipart/form-data" id="community_event_form">
                            ...
                            <div class="form-box bg-white mt-4">
                                ...
                                <div class="form-box-content p-3">
                                        ...
                                        <p>
                                          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#partJudul" aria-expanded="false" aria-controls="partJudul">
                                            JUDUL
                                          </button>
                                        </p>
                                        <div class="collapse" id="partJudul">
                                          <div class="card card-body">
                                             <div class="row">
                                                   <div class="col-md-2">
                                                        <label><?php echo e(__('Judul')); ?> <span class="required-star">*</span></label>
                                                    </div>
                                                    <div class="col-md-10">
                                        ...
                                        <p>
                                          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#partAbstrak" aria-expanded="false" aria-controls="partAbstrak">
                                            ABSTRAK
                                          </button>
                                        </p>
                                        <div class="collapse" id="partAbstrak">
                                          <div class="card card-body">
                                             <div class="row">
                                                   <div class="col-md-2">
                                                        <label><?php echo e(__('Abstrak')); ?> <span class="required-star">*</span></label>
                                                   </div>
                                                    <div class="col-md-10">
                                                        <textarea class="editor" id="abstrak" name="abstrak" rows="2">
                                                        </textarea>
                                                    </div>
                                              </div>      
                                          </div>
                                    ...
                                    <br> 
                                        ...
                                        <p>
                                          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#partTujuan" aria-expanded="false" aria-controls="partTujuan">
                                            TUJUAN / LATAR BELAKANG KEGIATAN
                                          </button>
                                        </p>
                                        <div class="collapse" id="partTujuan">
                                          <div class="card card-body">
                                            <div class="row">
                                                   <div class="col-md-2">
                                                        <label><?php echo e(__('Latar Belakang')); ?> <span class="required-star">*</span></label>
                                                   </div>
                                                    <div class="col-md-10">
                                                        <textarea class="editor" id="tujuan" name="tujuan" rows="3">
                                                        </textarea>
                                                    </div>
                                             </div>       
                                          </div>
                                    ...
                                    <br>  
                                        ...
                                        <p>
                                          <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#partTema" aria-expanded="false" aria-controls="partTema">
                                            TEMA KEGIATAN
                                          </button>
                                        </p>
                                        <div class="collapse" id="partTema">
                                          <div class="card card-body">
                                             <div class="row">
                                                   <div class="col-md-2">
                                  ...
                                  <div id="sec_desc_donasi" style="display: none;">
                                        <div class="row">
                                            <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <label><?php echo e(__('Dana Yang Diperlukan :')); ?> <span class="required-star"></span></label>
                                            </div>
                                            <div class="col-md-10">
                                                <input type="text" class="form-control mb-3 rounded-0" id="event_dana" name="event_dana" placeholder="Total Dana Yang Diperlukan (Rp.)" />
