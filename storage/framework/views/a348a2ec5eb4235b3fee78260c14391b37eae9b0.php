                    ...
                    <div class="col-xl-10 offset-xl-1">
                        <div class="card">
                            ...
                            <div class="px-5 py-3 py-lg-5">
                                <div class="row align-items-center">
                                    <div class="col-12 col-lg">
                                        <form class="form-default" role="form" action="<?php echo e(route('register.submit')); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group--style-1">
                                                            <input type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('Nama Lengkap')); ?>" name="name">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <!-- <label><?php echo e(__('email')); ?></label> -->
                                                        <div class="input-group input-group--style-1">
                                                            <input type="text" class="form-control" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(__('Nomor HP / Whatapp')); ?>" name="phone">
                                                            <span class="input-group-addon">
                                                                <i class="text-md fa fa-mobile"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-group--style-1">
                                                            <input type="password" class="form-control" placeholder="<?php echo e(__('Konfirmasi Password')); ?>" name="password_confirmation">
                                                            <span class="input-group-addon">
                                                                <i class="text-md la la-lock"></i>
                                                            </span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="checkbox pad-btm text-left">
                                                        ...
                                                        <label for="checkboxExample_1a" class="text-sm"><strong>
														<?php echo e(__('Ceklis bagian ini sebagai tanda anda setuju dengan Syarat dan Ketentuan Yang Berlaku.')); ?></strong></label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row align-items-center">
                                                <div class="col-12 text-right  mt-3">
                                                    <button type="submit" class="btn btn-styled btn-base-1 w-100 btn-md"><?php echo e(__('Buat Akun')); ?></button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg">
                                        <?php if(\App\BusinessSetting::where('type', 'google_login')->first()->value == 1): ?>
                                            <a href="<?php echo e(route('social.login', ['provider' => 'google'])); ?>" class="btn btn-styled btn-block btn-google btn-icon--2 btn-icon-left px-4 my-4">
                                                <i class="icon fa fa-google"></i> <?php echo e(__('Login dengan Google')); ?>
                                        ...
                                        <?php if(\App\BusinessSetting::where('type', 'facebook_login')->first()->value == 1): ?>
                                            <a href="<?php echo e(route('social.login', ['provider' => 'facebook'])); ?>" class="btn btn-styled btn-block btn-facebook btn-icon--2 btn-icon-left px-4 my-4">
                                                <i class="icon fa fa-facebook"></i> <?php echo e(__('Login dengan Facebook')); ?>
                                        ...
                                        <a href="<?php echo e(route('social.login', ['provider' => 'twitter'])); ?>" class="btn btn-styled btn-block btn-twitter btn-icon--2 btn-icon-left px-4 my-4">
                                            <i class="icon fa fa-twitter"></i> <?php echo e(__('Login dengan Twitter')); ?>
                            ...
                            <div class="text-center px-35 pb-3">
                                <p class="text-md">
                                    <?php echo e(__('Sudah Mempunyai Akun di Erbagi.com ?')); ?><a href="<?php echo e(route('user.login')); ?>" class="strong-600">&nbsp;<?php echo e(__('Log In')); ?></a>
                                </p>
                            </div>
                        </div>
                    </div>
