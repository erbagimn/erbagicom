        ...
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                <div class="col-lg-3 d-none d-lg-block">
                    <?php echo $__env->make('frontend.inc.community_side_nav', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
                                ...
                                <div class="dashboard-widget text-center red-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block title heading-3 strong-400">
                                            <?php echo e(count(\App\Event::where('id_komunitas', Auth::user()->id_komunitas)->get())); ?></span>
                                        <span class="d-block sub-title"><?php echo e(__('Event Kegiatan')); ?></span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center blue-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block sub-title"><?php echo e(__('Total Donasi')); ?></span>
                                    </a>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="dashboard-widget text-center yellow-widget mt-4 c-pointer">
                                    <a href="javascript:;" class="d-block">
                                        ...
                                        <span class="d-block sub-title"><?php echo e(__('Total Member')); ?></span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                ...
                                <div class="form-box bg-white mt-4">
                                    ...
                                    <div class="form-box-content p-3 category-widget">
                                        ...
                                        <div class="text-center">
                                            <a href="#" class="btn pt-3 pb-1"><?php echo e(__('Tambah Postingan Baru')); ?></a>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-12">
                                <div class="bg-white mt-4 p-4 text-center">
                                    <div class="heading-4 strong-700"><?php echo e(__('Event')); ?></div>
                                    <p><?php echo e(__('Kelola / Posting Event Anda')); ?></p>
                                    <a href="#" class="btn btn-styled btn-base-1 btn-outline btn-sm"><?php echo e(__('Create Event')); ?></a>
                                </div>
                                <!--
                                <div class="bg-white mt-4 p-4 text-center">
